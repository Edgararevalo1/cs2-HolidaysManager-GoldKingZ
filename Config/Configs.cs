...
namespace HolidaysManager_GoldKingZ.Config
{
    ...
    public class Reload_HolidaysManager
    {
        ...
        public string Reload_HolidaysManager_CommandsInGame { get; set; } = "Console_Commands: css_reloadholidays,css_reloadholiday | Chat_Commands: ";

        [Comment("If [Reload_HolidaysManager_CommandsInGame] Pass, Is There Any Specified Restricted Flags, Groups, SteamIDs")]
        [Comment("Example:")]
        ...
        public string Reload_HolidaysManager_Flags { get; set; } = "SteamIDs: 76561198206086993,STEAM_0:1:507335558 | Flags: @css/root,@css/admin | Groups: #css/root,#css/admin";

        [Comment("If [Reload_HolidaysManager_Flags] Pass, Hide Chat After Execute Reload_HolidaysManager_CommandsInGame?:")]
        [Comment("0 = No")]
        [Comment("1 = Yes, But Only After Toggle Successfully")]
        [Comment("2 = Yes, Hide All The Time")]
        [Range(0, 2, 0,
        "Reload_HolidaysManager_Hide: is invalid, setting to default value (0) Please Choose From 0 To 2.\n" +
        "0 = No\n" +
        "1 = Yes, But Only After Toggle Successfully\n" +
        "2 = Yes, Hide All The Time")]
        public int Reload_HolidaysManager_Hide { get; set; } = 0;
    }
    ...
    public class Config
    {
        ...
        [Comment("Reload HolidaysManager Plugin")]
        public Reload_HolidaysManager Reload_HolidaysManager { get; set; } = new();

        [BreakLine("----------------------------[ ↓ SkyBox Config ↓ ]----------------------------{nextline}")]

        [Comment("Path Of SkyBox")]
        [Comment("\"\" = Disable")]
        public string SkyBox_Path { get; set; } = "materials/goldkingz/skybox/skybox_snow.vmat";

        [Comment("SkyBox Color By (Red, Green, Blue, Alpha) Use This Site [https://rgbacolorpicker.com/]")]
        public string SkyBox_Color { get; set; } = "255, 255, 255, 255";
        
        [Comment("SkyBox Brightness")]
        public float SkyBox_Brightness { get; set; } = 0.5f;

        [Comment("SkyBox Rotation")]
        [String("X", "Y", "Z")]
        public string SkyBox_Rotation_XYZ { get; set; } = "X:  | Y: 100 | Z: ";

        [BreakLine("----------------------------[ ↓ SnowFall Config ↓ ]----------------------------{nextline}")]

        [Comment("Enable SnowFall?")]
        [Comment("0 = No")]
        [Comment("1 = Yes")]
        ...
        [Range(0, 3, 1,
        "SnowFall: is invalid, setting to default value (1) Please Choose From 0 To 3.\n" +
        "0 = No\n" +
        "1 = Yes\n" +
        ...
        public int SnowFall { get; set; } = 1;

        [Comment("If [SnowFall = 1 or 2 or 3], Whats Path Of Snow Particle Effect")]
        [Comment("\"\" = Disable")]
        public string SnowFall_Path { get; set; } = "particles/goldkingz/snowing/snowing.vpcf";

        [Comment("Height Of [SnowFall_Path] Z-Axis")]
        public float SnowFall_Z_Height { get; set; } = 300.0f;

        [Comment("If [SnowFall = 2 or 3], Commands To Toggle")]
        [Comment("Note: Console_Commands Can Be Execute Via Both Console And Chat By (!)")]
        [Comment("Making Both Console_Commands And Chat_Commands Empty = Disable")]
        [String("Console_Commands", "Chat_Commands")]
        public string SnowFall_CommandsInGame { get; set; } = "Console_Commands: css_snow,css_snowfall | Chat_Commands: ";

        [Comment("If [SnowFall_CommandsInGame] Pass, Is There Any Specified Restricted Flags, Groups, SteamIDs")]
        [Comment("Example:")]
        [Comment("\"SteamIDs: 76561198206086993,STEAM_0:1:507335558 | Flags: @css/root,@css/admin | Groups: #css/root,#css/admin\"")]
        [Comment("\"SteamIDs:  | Flags:  | Groups: \" = To Allow Everyone")]
        [String("SteamIDs", "Flags", "Groups")]
        public string SnowFall_Flags { get; set; } = "SteamIDs: | Flags: @css/vip,@css/vips | Groups: #css/vips,#css/vip";

        [Comment("If [SnowFall_Flags] Pass, Hide Chat After Execute SnowFall_CommandsInGame?:")]
        [Comment("0 = No")]
        [Comment("1 = Yes, But Only After Toggle Successfully")]
        [Comment("2 = Yes, Hide All The Time")]
        [Range(0, 2, 0,
        "SnowFall_Hide: is invalid, setting to default value (0) Please Choose From 0 To 2.\n" +
        "0 = No\n" +
        "1 = Yes, But Only After Toggle Successfully\n" +
        "2 = Yes, Hide All The Time")]
        public int SnowFall_Hide { get; set; } = 0;

        

        [BreakLine("----------------------------[ ↓ Prop Config ↓ ]----------------------------{nextline}")]

        [Comment("Enable Props?")]
        [Comment("0 = No")]
        [Comment("1 = Yes")]
        [Comment("2 = Yes, But Make It Togglable And Enabled By Default To New Players")]
        [Comment("3 = Yes, But Make It Togglable And Disabled By Default To New Players")]
        [Range(0, 3, 1,
        "Props: is invalid, setting to default value (1) Please Choose From 0 To 3.\n" +
        "0 = No\n" +
        "1 = Yes\n" +
        "2 = Yes, But Make It Togglable And Enabled By Default To New Players\n" +
        "3 = Yes, But Make It Togglable And Disabled By Default To New Players")]
        public int Props { get; set; } = 1;

        [Comment("If [Props = 2 or 3], Commands To Toggle")]
        [Comment("Note: Console_Commands Can Be Execute Via Both Console And Chat By (!)")]
        [Comment("Making Both Console_Commands And Chat_Commands Empty = Disable")]
        [String("Console_Commands", "Chat_Commands")]
        public string Props_CommandsInGame { get; set; } = "Console_Commands: css_prop,css_props | Chat_Commands: ";

        [Comment("If [Props_CommandsInGame] Pass, Is There Any Specified Restricted Flags, Groups, SteamIDs")]
        [Comment("Example:")]
        [Comment("\"SteamIDs: 76561198206086993,STEAM_0:1:507335558 | Flags: @css/root,@css/admin | Groups: #css/root,#css/admin\"")]
        [Comment("\"SteamIDs:  | Flags:  | Groups: \" = To Allow Everyone")]
        [String("SteamIDs", "Flags", "Groups")]
        public string Props_Flags { get; set; } = "SteamIDs: | Flags: @css/vip,@css/vips | Groups: #css/vips,#css/vip";

        [Comment("If [Props_Flags] Pass, Hide Chat After Execute Props_CommandsInGame?:")]
        [Comment("0 = No")]
        [Comment("1 = Yes, But Only After Toggle Successfully")]
        [Comment("2 = Yes, Hide All The Time")]
        [Range(0, 2, 0,
        "Props_Hide: is invalid, setting to default value (0) Please Choose From 0 To 2.\n" +
        "0 = No\n" +
        "1 = Yes, But Only After Toggle Successfully\n" +
        "2 = Yes, Hide All The Time")]
        public int Props_Hide { get; set; } = 0;

        [Comment("If [Props = 1 or 2 or 3], Commands To Enter Edit Mode For Prop")]
        [Comment("Note: Console_Commands Can Be Execute Via Both Console And Chat By (!)")]
        [Comment("Making Both Console_Commands And Chat_Commands Empty = Disable")]
        [String("Console_Commands", "Chat_Commands")]
        public string Props_Edit_Mode_CommandsInGame { get; set; } = "Console_Commands: css_edit,css_editmode | Chat_Commands: ";

        [Comment("If [Props_Edit_Mode_CommandsInGame] Pass, Is There Any Specified Restricted Flags, Groups, SteamIDs")]
        [Comment("Example:")]
        [Comment("\"SteamIDs: 76561198206086993,STEAM_0:1:507335558 | Flags: @css/root,@css/admin | Groups: #css/root,#css/admin\"")]
        [Comment("\"SteamIDs:  | Flags:  | Groups: \" = To Allow Everyone")]
        [String("SteamIDs", "Flags", "Groups")]
        public string Props_Edit_Mode_Flags { get; set; } = "SteamIDs: 76561198206086993,STEAM_0:1:507335558 | Flags: @css/root,@css/admin | Groups: #css/root,#css/admin";

        [Comment("If [Props_Edit_Mode_Flags] Pass, Hide Chat After Execute Props_Edit_Mode_CommandsInGame?:")]
        [Comment("0 = No")]
        [Comment("1 = Yes, But Only After Toggle Successfully")]
        [Comment("2 = Yes, Hide All The Time")]
        [Range(0, 2, 0,
        "Props_Edit_Mode_Hide: is invalid, setting to default value (0) Please Choose From 0 To 2.\n" +
        "0 = No\n" +
        "1 = Yes, But Only After Toggle Successfully\n" +
        "2 = Yes, Hide All The Time")]
        public int Props_Edit_Mode_Hide { get; set; } = 0;

        [Comment("Make Refill SnowBalls If Spawn Props With Mode 2 or 3")]
        [Comment("0 = Unlimted")]
        [Range(0, 9999, 3, "Props_Mode2And3_Max: is invalid, setting to default value (3) Please Choose From 0 To 9999.")]
        public int Props_Mode2And3_Max { get; set; } = 3;

        [Comment("Time In (Secs) Give CoolDown On Next Refill On Props Mode 2 or 3")]
        [Comment("0 = Unlimted")]
        [Range(0, 9999, 5, "Props_Mode2And3_Refill_CoolDown: is invalid, setting to default value (5) Please Choose From 0 To 9999.")]
        public int Props_Mode2And3_Refill_CoolDown { get; set; } = 5;

        [Comment("Immunity From Cooldown")]
        [Comment("Flags Or Group Or SteamID")]
        [Comment("Example:")]
        [Comment("\"SteamIDs: 76561198206086993,STEAM_0:1:507335558 | Flags: @css/root,@css/admin | Groups: #css/root,#css/admin\"")]
        [Comment("\"SteamIDs:  | Flags:  | Groups: \" = Everyone Will Have Immunity From Cooldown")]
        [String("SteamIDs", "Flags", "Groups")]
        public string Immunity_From_Cooldown_Props_Mode2And3_Refill { get; set; } = "SteamIDs: | Flags: @css/root,@css/admin | Groups: #css/root,#css/admin";


        [BreakLine("----------------------------[ ↓ Decoy To SnowBall Config ↓ ]----------------------------{nextline}")]

        [Comment("SnowBall Model Skin")]
        [Comment("\"\" = Disable")]
        public string SnowBall_Model { get; set; } = "models/goldkingz/snowball/snowball.vmdl";

        [Comment("SnowBall Model Skin ag2")]
        [Comment("\"\" = Disable")]
        public string SnowBall_Model_ag2 { get; set; } = "models/goldkingz/snowball/ag2/snowball_ag2.vmdl";

        [Comment("Give (x) Snowballs On Spawn")]
        [Comment("0 = None")]
        [Range(0, 9999, 3, "SnowBall_GiveOnSpawn: is invalid, setting to default value (3) Please Choose From 0 To 9999.")]
        public int SnowBall_GiveOnSpawn { get; set; } = 3;

        [Comment("SnowBall Trail Particle")]
        [Comment("\"\" = Disable")]
        public string SnowBall_Trail_Particle { get; set; } = "particles/goldkingz/weapons/snowball_trail/snowball_trail.vpcf";

        [Comment("SnowBall Trail Particle Color By (Red, Green, Blue, Alpha) Use This Site [https://rgbacolorpicker.com/]")]
        public string SnowBall_Trail_Particle_Color { get; set; } = "255, 255, 255, 255";

        [Comment("SnowBall Hit Particle")]
        [Comment("\"\" = Disable")]
        public string SnowBall_Hit_Particle { get; set; } = "particles/goldkingz/weapons/snowball_impact/snowball_impact.vpcf";

        [Comment("SnowBall Hit Particle Color By (Red, Green, Blue, Alpha) Use This Site [https://rgbacolorpicker.com/]")]
        public string SnowBall_Hit_Particle_Color { get; set; } = "255, 255, 255, 255";

        [Comment("SnowBall Damage On Hit")]
        [Comment("0 = No Damage")]
        [Range(0, 9999, 5, "SnowBall_Damage: is invalid, setting to default value (5) Please Choose From 0 To 9999.")]
        public int SnowBall_Damage { get; set; } = 5;

        [Comment("SnowBall Hit Sound Effect")]
        public string SnowBall_Hit_Sound { get; set; } = "Player.SnowballHit";

        [Comment("Custom Throw SnowBall Messages?:")]
        [Comment("0 = No")]
        [Comment("1 = Yes, But Show SnowBall Message To Team Side But Exclude Bots")]
        [Comment("2 = Yes, But Show SnowBall Message To Team Side But Include Bots")]
        [Comment("3 = Yes, But Show SnowBall Message To All But Exclude Bots")]
        [Comment("4 = Yes, But Show SnowBall Message To All But Include Bots")]
        [Comment("5 = Yes, But Show SnowBall Message To Player Side When (mp_teammates_are_enemies true)")]
        [Comment("6 = Yes, But Show SnowBall Message To All When (mp_teammates_are_enemies true) But Exclude Bots")]
        [Comment("7 = Yes, But Show SnowBall Message To All When (mp_teammates_are_enemies true) But Include Bots")]
        [Range(0, 7, 2,
        "SnowBall_Message_Announcement: is invalid, setting to default value (2) Please Choose From 0 To 7.\n" +
        "0 = No\n" +
        "1 = Yes, But Show SnowBall Message To Team Side But Exclude Bots\n" +
        "2 = Yes, But Show SnowBall Message To Team Side But Include Bots\n" +
        "3 = Yes, But Show SnowBall Message To All But Exclude Bots\n" +
        "4 = Yes, But Show SnowBall Message To All But Include Bots\n" +
        "5 = Yes, But Show SnowBall Message To Player Side When (mp_teammates_are_enemies true)\n" +
        "6 = Yes, But Show SnowBall Message To All When (mp_teammates_are_enemies true) But Exclude Bots\n" +
        "7 = Yes, But Show SnowBall Message To All When (mp_teammates_are_enemies true) But Include Bots")]
        public int SnowBall_Message_Announcement { get; set; } = 2;
        
        [BreakLine("----------------------------[ ↓ Locally Config ↓ ]----------------------------{nextline}")]

        [Comment("Save Players Data By Cookies Locally (In ../HolidaysManager-GoldKingZ/cookies/)?")]
        [Comment("0 = No")]
        ...
        [Comment("Auto Update Signatures (In ../HolidaysManager-GoldKingZ/gamedata/)?")]
        [Comment("true = Yes")]
        [Comment("false = No")]
        ...
        [Comment("true = Yes")]
        [Comment("false = No")]
        public bool AutoPrecacheResources { get; set; } = true;
    ...
    public static class Configs
    {
        ...
        public static string Github = "https://github.com/oqyh/cs2-HolidaysManager-GoldKingZ";
